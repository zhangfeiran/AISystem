...
![三维张量示例](../../imageswtf/05Framework-03DataFlow-images-graph_framework02.png)
...
![对应计算图](../../imageswtf/05Framework-03DataFlow-images-forward_mode01.png)
...
![对应计算图](../../imageswtf/05Framework-03DataFlow-images-compute_graph03.png)
...
![对应计算图](../../imageswtf/05Framework-03DataFlow-images-compute_graph04.png)

对于上面表达式求值的过程称之为反向微分。在反向微分中，变量导数的计算顺序与变量的前向计算顺序正好相反；运行的时间复杂度是 $O(m)$，$m$ 是输出变量的个数。因此可以构建相对应的反向计算图：

![对应计算图](../../imageswtf/05Framework-03DataFlow-images-compute_graph06.png)
...
![对应计算图](../../imageswtf/05Framework-03DataFlow-images-compute_graph05.png)
...
![对应计算图](../../imageswtf/05Framework-03DataFlow-images-framework04.png)
