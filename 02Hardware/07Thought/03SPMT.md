...
![流水执行 PPE](../../imageswtf/02Hardware-07Thought-images-03SPMT02.png)
...
![没有采用乱序执行](../../imageswtf/02Hardware-07Thought-images-03SPMT03.png)

因此采用乱序执行，在 CPU 空闲时间执行指令 2，由于指令 4 的执行需要指令 1 在写回结果之后，所以需要把依赖性指令移到独立指令后，在指令 1 完全执行之后再执行指令 4，同时 for 循环由硬件通过指令动态展开。

![采用乱序执行](../../imageswtf/02Hardware-07Thought-images-03SPMT04.png)
...
![超长指令字](../../imageswtf/02Hardware-07Thought-images-03SPMT05.png)
...
![SIMD](../../imageswtf/02Hardware-07Thought-images-03SPMT06.png)
...
![SPMD](../../imageswtf/02Hardware-07Thought-images-03SPMT07.png)
...
![GPU SIMT & SIMD](../../imageswtf/02Hardware-07Thought-images-03SPMT08.png)
...
![英伟达 GPU SIMT](../../imageswtf/02Hardware-07Thought-images-03SPMT09.png)

## 三者间关系

SISD、SIMD 和 SIMT 按照时间轴的执行方式如下所示。

![SISD、SIMD 和 SIMT 时序对比](../../imageswtf/02Hardware-07Thought-images-03SPMT10.png)
