...
![不同精度表示](../../imageswtf/04Inference-03Slim-images-02Quant01.png)
...
![神经网络的发展](../../imageswtf/04Inference-03Slim-images-02Quant02.png)
...
![性能对比](../../imageswtf/04Inference-03Slim-images-02Quant04.png)
...
![三种量化方法](../../imageswtf/04Inference-03Slim-images-02Quant05.png)
...
![非饱和量化](../../imageswtf/04Inference-03Slim-images-02Quant06.png)

2. 饱和量化

饱和量化方法使用 KL 散度计算一个合适的阈值 T ($0<T<abs\_max$)，将 $±|T|$ 映射为 ±127，超出阈值  $±|T|$ 外的直接映射为阈值 ±127，则量化比例因子（scale）等于 $T/127$。

![饱和量化](../../imageswtf/04Inference-03Slim-images-02Quant07.png)
...
![对称量化](../../imageswtf/04Inference-03Slim-images-02Quant08.png)
...
![非对称量化](../../imageswtf/04Inference-03Slim-images-02Quant09.png)
