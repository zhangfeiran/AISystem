...
![卷积可视化动图](../../imageswtf/04Inference-06Kernel-images-02Conv01.png) 
...
![卷积取值的示例](../../imageswtf/04Inference-06Kernel-images-02Conv02.png) 
...
![t 不同取值情况下卷积的示例](../../imageswtf/04Inference-06Kernel-images-02Conv03.png) 
...
![系统随时间 t 的响应函数](../../imageswtf/04Inference-06Kernel-images-02Conv04.png) 
...
![任意时刻下系统的输入信号示意图](../../imageswtf/04Inference-06Kernel-images-02Conv05.png) 

如下图(左)所示，由于信号的响应随时间衰减，我们假定每个时刻的新信号产生的响应的影响范围为 5 个等距时间段 $T$，即在 $t_{0}$ 产生的新信号的响应影响至 $t_{5}$ 时刻。那么在 $T=t_{5}$ 时刻，输出结果跟图中绿色框的区域整体有关。

![输出结果示意图](../../imageswtf/04Inference-06Kernel-images-02Conv06.png) 
...
![对称变换后输出结果示意图](../../imageswtf/04Inference-06Kernel-images-02Conv07.png) 

进一步，将 $g(-t_{i})$ 图像右移 $T$ 个时间单位，得到 $g(T-t_{i})$：

![平移后输出结果示意图](../../imageswtf/04Inference-06Kernel-images-02Conv08.png) 
...
如下图所示, 神经网络中的卷积计算过程可描述为：$3 * 3$ 的卷积核在 $8 * 8$ 的图像上进行滑动，每次滑动时，都把卷积核和对应位置的元素进行相乘再求和。青色区域为其感受野。
 ...
 ![神经网络中卷积计算过程](../../imageswtf/04Inference-06Kernel-images-02Conv09.png) 
...
![卷积乘加过程](../../imageswtf/04Inference-06Kernel-images-02Conv11.png) 
...
![卷积滑动求和过程](../../imageswtf/04Inference-06Kernel-images-02Conv12.png) 
...
![卷积加偏置过程](../../imageswtf/04Inference-06Kernel-images-02Conv13.png) 
...
![张量](../../imageswtf/04Inference-06Kernel-images-02Conv14.png) 
...
![张量卷积计算示意图](../../imageswtf/04Inference-06Kernel-images-02Conv15.png) 
