...
![Constant folding](../../imageswtf/04Inference-05Optimize-images-02Basic01.png)
...
![ExpandDims](../../imageswtf/04Inference-05Optimize-images-02Basic02.png)
...
![Binary](../../imageswtf/04Inference-05Optimize-images-02Basic03.png)
...
![Op 本身无意义](../../imageswtf/04Inference-05Optimize-images-02Basic04.png)
...
![Op 无意义示例](../../imageswtf/04Inference-05Optimize-images-02Basic05.png)
...
![Op 参数无意义](../../imageswtf/04Inference-05Optimize-images-02Basic06.png)
...
![Op 参数无意义示例](../../imageswtf/04Inference-05Optimize-images-02Basic07.png)

### Op 位置无意义

一些 Op 在计算图中特殊位置会变得多余无意义。

![Op 位置无意义](../../imageswtf/04Inference-05Optimize-images-02Basic08.png)

详细示例如下所示：

示例中的 cast 算子，unsqueeze 算子以及无后续输出的 op1 和在 global pooling 之后的 reshape/flatten 算子等，均可以进行冗余算子的消除。

![Op 位置无意义](../../imageswtf/04Inference-05Optimize-images-02Basic09.png)
...
![Op 位置无意义](../../imageswtf/04Inference-05Optimize-images-02Basic10.png)
...
![Op 前后反义](../../imageswtf/04Inference-05Optimize-images-02Basic11.png)
...
![公共子图](../../imageswtf/04Inference-05Optimize-images-02Basic12.png)
...
![算子融合 conv](../../imageswtf/04Inference-05Optimize-images-02Basic13.png)
...
![算子融合 matmul](../../imageswtf/04Inference-05Optimize-images-02Basic14.png)
...
![算子替换 replace1vs1](../../imageswtf/04Inference-05Optimize-images-02Basic15.png)
...
![算子替换 replace1vsn](../../imageswtf/04Inference-05Optimize-images-02Basic16.png)
...
![算子前移](../../imageswtf/04Inference-05Optimize-images-02Basic17.png)
